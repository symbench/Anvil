...
def run():
     ...
     def run_cfd():
        ...
        logging.debug('->dex source loc:', dex_source_loc)
     ...
     if mode=="optimization":
        ...
        logging.info('==> Optimization method is:',optimization_method,',Budget is:%s',budget,',Aq func:',aq_func,',optimization target is:%s',target,'.') 
